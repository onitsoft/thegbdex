                  ...
                  <div id="faq.list" className={styles.list}>
                    ...
                    {this.showQuestion(7) ? (
                      <QuestionAnswer
                        ...
                        answer={
                          <p>
                            All fiat operation on the theGBdex are performed via the partnership with{' '}
                            <a href="https://n.exchange/?ref=gbdex" target="_blank" rel="noopener noreferrer">
                              n.exchange
                            </a>
                            . KYC and AML/CTF compliance is also thus handled by n.exchange according to the highest standards of fraud
                            prevention, data protection and information security.
                          </p>
                        }
                      />
                    ) : null}
