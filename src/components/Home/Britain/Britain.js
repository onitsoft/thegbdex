      ...
      {t => (
        <div className={`container row ${styles.container}`}>
          ...
          <div className={`col-sm-12 col-md-10 col-lg-7 ${styles.subcontainer}`}>
            <span>
              Based In Glasgow, Scotland, UK, We're Your Local Cryptocurrency Exchange Helping You Better Understand, Trade And Invest In
              Bitcoin. Get Started Today.
            </span>
          </div>
          <div className={`col-sm-12 ${styles.cardlist}`}>
            ...
            <div className="row">
              ...
              <div className={`col-sm-12 col-md-6 col-lg-4 ${styles.cardouter}`}>
                <div className={styles.card}>
                  <div className={styles.icon}>
                    <img src="/img/otc-services.svg" alt="Buy in seconds" />
                  </div>
                  <span>WHITE-GLOVE OTC SERVICES</span>
                </div>
              </div>
            </div>
          </div>
